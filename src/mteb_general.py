...
from eval.MTEB.utils import logger, pool, move_to_cuda
...
parser.add_argument('--prompt', default='Represent this sentence for searching relevant passages: ', help='prompt')
...
assert args.prompt in ['', 'query: ', 'passage: ', 'Represent this sentence for searching relevant passages: ']
